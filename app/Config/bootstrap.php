...
// Cache::config('short', array('engine' => 'File','duration' => '+1 hours'));


//Cache::config('cake_acl_aros_model_user', array(
    //'engine' => 'File',
    //'duration' => '+1 week',
    //'path' => CACHE,
    //'prefix' => 'cake_acl_model_'
//));
...
CakePlugin::load('Pws', array('bootstrap' => false, 'routes' => false));
