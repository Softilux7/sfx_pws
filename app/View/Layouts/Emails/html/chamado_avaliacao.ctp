...
<table width='635' style="background-color:#FFF;" border='0' align='center' cellpadding='0' cellspacing='0'>
    ...
    <tr>
        <td align='center' valign="middle" bgcolor='#012B49'><h3 style="margin-top:20px"><strong><br>
                    <span style="color:#FFF; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif" >AVALIAÇÃO DE CHAMADO:</span><span style="color:#FFf; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif" > <?php echo $numero; ?></span></strong></h3></td>
    </tr>
    <tr>
        <td align='center'></td>
    </tr>
    <tr>
        <td><table width='500' border='0' align='center' cellpadding='0' cellspacing='0' style="margin-top:10px">
                ...
                <tr>
                    <td colspan='2' align="center"> <p><span style="font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif">Avalie agora esse chamado</span></p>
