                    ...
                    <td colspan='2'><hr>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <? if($auth_user['User']['empresa_id'] == 42){?>
                                <td><span style="font-family:'Courier New', Courier, monospace, Helvetica, sans-serif"><strong>Contador</strong></span></td>
                                <? } ?>
                            ...
                            <?php foreach ($suprimentos as $suprimentos): ?>
                                <tr>
                                    ...
                                    <? if($auth_user['User']['empresa_id'] == 42){?>
                                    <td><?php echo $suprimentos['SolicitacaoSuprimento']['contador']; ?></td>
                                    <? } ?>
