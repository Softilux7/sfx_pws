			...
			<div class="panel-body">
				...
				<div class=" ">
					<div class="control-group">
						...
						<div class="controls">
							<?php
							//echo $this->request->data('Empresa.logo');
							echo $this->Form->input('Empresa.logo1', array('type' => 'hidden','value'=>$this->request->data('Empresa.logo')));
							//echo $this->Form->input('logo', array('type'=>'text','div' => false, 'label' => false, 'disabled' => false, 'error' => false, 'class' => 'input-xxsmall')); ?>
							<?php
							echo $this->Form->input('Empresa.logo', array('type' => 'file'));
							?>
