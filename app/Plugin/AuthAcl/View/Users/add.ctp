        ...
        <div class="row-fluid">
            <div class="panel panel-default">
                                        ...
                                        <div class="panel panel-warning">
                                            ...
                                            <div class="panel-body">
                                                <div
                                                    ...
                                                    <div class="controls">
                                                        <?php echo $this->Form->input('user_email', array('div' => false, 'class' => 'input-xlarge', 'label' => false, 'error' => false)); ?>
                                                    </div>
                                                </div>
                                                <div
                                                    ...
                                                    <label for="inputEmail" class="control-label"><?php echo __('Senha'); ?>
                                                        <span style="color: red;">*</span>
                                                    </label>
                                                    <div class="controls">
                                                        <?php echo $this->Form->password('user_password', array('div' => false, 'class' => 'input-xlarge', 'label' => false, 'error' => false)); ?>
                                                    </div>
                                                </div>
                                                <div
                                                    ...
                                                    <label for="inputEmail" class="control-label"><?php echo __('Confirmar Senha'); ?>
                                                        <span style="color: red;">*</span>
                                                    </label>
                                                    <div class="controls">
                                                        <?php echo $this->Form->password('user_confirm_password', array('div' => false, 'class' => 'input-xlarge', 'label' => false, 'error' => false)); ?>
                                                    </div>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <label for="inputEmail" class="control-label"><?php echo __('Nome'); ?>
                                                        <span style="color: red;">*</span>
                                                    </label>
                                                    <div class="controls">
                                                ...
                                                <div class="control-group">
                                                    <label for="group" class="control-label"><?php echo __('Tipo de Usuário'); ?>
                                                        <span style="color: red;">*</span>
                                                    </label>
                                                    <div class="controls">
                                                ...
                                                <div class="control-group" id="clienteBox">
                                                    <label for="Cliente" class="control-label"><?php echo __('Cliente'); ?>
                                                        <span id="id_cliente_required" style="color: red;">*</span>
                                                    </label>
                                                    <div class="controls">
                                                        <?php //echo $this->Form->input('Cliente', array('div' => false, 'label' => false, 'empty' => ' ')); ?>
                                                        <select id="Cliente" class="js-example-data-array" name="data[Cliente][Cliente][]">
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="control-group" id="tecnicoBox">
                                                    <label for="tecnicos" class="control-label">
                                                        <?php echo __('Técnico'); ?><span id="id_tecnico_required" style="color: red;">*</span>
                                                    </label>
                                                    <div class="controls">
                                                        <?php
                                                ...
                                                <div class="control-group" id="entregadorBox">
                                                    <label for="entregador" class="control-label"><?php echo __('Entregadores'); ?></label>
                                                    <div class="controls">
                                                        <?php
                                                ...
                                                <div class="control-group">
                                                    <label for="Empresa" class="control-label"><?php echo __('Empresa Matriz'); ?>
                                                        <span style="color: red;">*</span>
                                                    </label>
                                                    <div class="controls">
                                                ...
                                                <div class="control-group">
                                                    <label for="Filiais" class="control-label"><?php echo __('Empresas Filiais'); ?>
                                                        <span style="color: red;">*</span>
                                                    </label>
                                                    <div class="controls">
                ...
                <div class="panel-footer">
                    <input type="submit" class="btn btn-large btn-primary" value="<?php echo __('Salvar Usuário'); ?>"/>
...
<script>
    ...
    function PegarValor() {
        ...
        if (document.getElementById('group').value === "6") { // Admin
            document.getElementById('entregadorBox').style.display = "block";
            document.getElementById('clienteBox').style.display = "block";
            document.getElementById('tecnicoBox').style.display = "block";
            document.getElementById('inputEmail').style.display = "block";
        ...
        if (document.getElementById('group').value === "2") { // Tecnico
            ...
            document.getElementById('tecnicoBox').style.display = "block";
            document.getElementById('inputEmail').style.display = "block";
            $("#id_tecnico_required").show();
            $("#tecnicos").attr('required', 'true');
        } else {
            $("#id_tecnico_required").hide();
        ...
        if (document.getElementById('group').value === "3") { // Cliente
            ...
            $("#id_cliente_required").show();
            $("#Cliente").attr('required', 'true');
        } else {
            $("#id_cliente_required").hide();
