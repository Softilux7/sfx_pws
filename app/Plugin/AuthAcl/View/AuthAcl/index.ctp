            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body" style="min-height: 200px;">
                    <div class="tac">
                        ...
                        <?php if ($this->Acl->check('Chamados', 'index', 'Pws') == true && ($auth_user_group['id'] != 4 )) { ?>
                        ...
                        <?php if (($this->Acl->check('DFaturamentos', 'index', 'Pws') == true) && ($auth_user_group['id'] == 8 || $auth_user_group['id'] == 1 || $auth_user_group['id'] == 6)) { ?>
                        ...
                        <?php if ($this->Acl->check('AcompanharAtendimento', 'index', 'Pws') == true && ($auth_user_group['id'] == 6 || $auth_user_group['id'] == 1)) { ?>
                        <?php
                        // _tst($auth_user)
                        ...
                        <?php if ($this->Acl->check('Solicitacao', 'index', 'Pws') == true && ($auth_user_group['id'] == 1 || $auth_user_group['id'] == 6 || $auth_user_group['id'] == 4 || $auth_user_group['id'] == 7)) { ?>
                        ...
                        <?php if ($this->Acl->check('Chamados', 'edit', 'Pws') == true && ($auth_user_group['id'] == 2 || $auth_user_group['id'] == 6 || $auth_user_group['id'] == 1)) { ?>
                            <a href="<?php echo Router::url(array('plugin' => 'pws', 'controller' => 'Chamados', 'action' => 'index')); ?>"
                               class="quick-btn">
                        ...
                        <?php if ($this->Acl->check('NfsaidaEntregas', 'index', 'Pws') == true && ($auth_user_group['id'] == 5 || $auth_user_group['id'] == 6 || $auth_user_group['id'] == 1)) { ?>
                        ...
                        <?php if ($this->Acl->check('Relatorios', 'index', 'Pws') == true && ($auth_user_group['id'] == 7 || $auth_user_group['id'] == 3 || $auth_user_group['id'] == 6 || $auth_user_group['id'] == 1)) { ?>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php foreach ($Chamados as $chamado): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            if(isset($chamado['Atendimento'])){

                                                $destino= $chamado['Atendimento']['ANDAMENTO_CHAMADO_APP'];

                                                if($destino != '15' && $destino !='30' && $destino != ""){
                                                    if($destino == '2'|| $destino == '3'){
                                                        echo "Em rota";
                                                    }else if($destino >= '4' && $destino <= '11'){
                                                        echo "No cliente";
                                                    }else if($destino == '23'){
                                                        echo "R. empresa";
                                                    }else if($destino == '24'){
                                    ...
                                    <?php
                                        if(isset($chamado['Atendimento'])){
                                            ...
                                            if($destino !='15' && $destino !='30' && $destino != ""){
                                                switch($chamado['Atendimento']['DESLOCAMENTO_APP']){
                                                    case '1' : 
                                                        echo "Veículo"; 
                                                        break;
                                                    case '2' : 
                                                        echo "T. Público/Privado"; 
                                                        break;
                                                    case '0' : 
                                                        echo "Sem deslocamento"; 
                                                        break;
                                                    default:
                                                        echo "-";
                                                }
