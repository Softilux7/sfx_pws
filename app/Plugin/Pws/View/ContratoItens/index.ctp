<div id="equipamentos" class="span12">
    <div class="row-fluid">
        <div class="span12">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                echo $this->Search->selectFields('filter1', array(
                                    ...
                                    'Equipamento.NRCONTRATO' => __('Contrato', true),
            ...
            foreach ($Equipamentos as $Equipamento) :
                ...
                <div class="row-fluid show-grid" style="margin-top: 10px;">
                    <div class="span12 well">
                        <div class="span3">
                            <div><strong>Série:</strong>&nbsp;<?php echo h($Equipamento['Equipamento']['SERIE']); ?>
                            </div>
                            <div>
                                <strong>Patrimônio:</strong>&nbsp;<?php echo h($Equipamento['Equipamento']['PATRIMONIO']); ?>
                            </div>
                            <div>
                        ...
                        <div class="span3">
                            <div><strong>Modelo: </strong>&nbsp;<?php echo h($Equipamento['Equipamento']['MODELO']); ?>
                            </div>
                            <div>
                                <strong>Contrato: </strong>&nbsp;<?php echo h($Equipamento['Contrato']['SEQCONTRATO']) . " / " . h($Equipamento['Contrato']['NRCONTRATO']); ?>
                            </div>
                            <?php if ($Equipamento['Equipamento']['ID_BASE'] == 4) { ?>
                            <div><strong>Tempo
                                    Solução:</strong>&nbsp;<?php echo h($Equipamento['Equipamento']['TEMPOFECHAMENTO']); ?>
                            </div>
                            <?php } ?>
                        </div>
                        <div class="span3">
                            <div><strong>Cidade: </strong>&nbsp;<?php echo h($Equipamento['Equipamento']['CIDADE']); ?>
                                &nbsp;</div>
                            <div>
                            ...
                            <div>
                                <strong>Local de
                                    Instalação: </strong><?php echo h($Equipamento['Equipamento']['LOCALINSTAL']); ?>
                            </div>
                        </div>
                        <div class="span3 text-right">&nbsp;
                            ...
                            <a href="javascript:checkChamadoEquipamento(<?php echo $Equipamento ['Equipamento'] ['ID_BASE']?>,<?php echo $Equipamento ['Equipamento'] ['empresa_id']?>,<?php echo $Equipamento ['Equipamento'] ['CDEQUIPAMENTO']?>,<?php echo $Equipamento ['Equipamento'] ['CDCLIENTE']?>,<?php echo $Equipamento ['Equipamento'] ['id']?>)" class="btn btn-large btn-info" title="Abrir Chamado Técnico">
                                <i class="fa fa-plus"></i>&nbsp;<span id="linkLabelChamado">Chamado</span>
                            </a>
                            &nbsp;
                            <?php
                            ...
                            ?>
                            <?php if ($Equipamento['Equipamento']['ID_BASE'] == 4) { ?>
                                <?php if ($this->Acl->check('Equipamentos', 'editTemp', 'Pws') == true) { ?>
                                    <a class="btn btn-large btn-primary" title="Alterar Tempo Fechamento"
                                       data-toggle="modal"
                                       href="#"
                                       onclick='formEditData("<?php echo h($Equipamento['Equipamento']['id']); ?>");'><i
...
<script type="text/javascript">
    ...
    function formEditData(group_id) {

        var header = "<?php echo __('Atualizar Tempo Solução'); ?>";

        var idField = '';
        idField = '<input type="hidden" name="data[Equipamento][id]" value="' + group_id + '" />';

        var mId = $.sModal({
            header: header,
            animate: 'fadeDown',
            content: '<div id="group_error"></div> <form style="margin:0"> Tempo de Fechamento<span style="color:red;">*</span> &nbsp; <input type="text" id="tempoFechamento" class="input-medium"  name="data[Equipamento][TEMPOFECHAMENTO]"/>' + idField + '<form>',
            buttons: [
                {
                    text: '&nbsp; <?php echo __('Ok'); ?> &nbsp;',
                    ...
                    click: function (id) {
                        ...
                        $.post('<?php echo Router::url(array('plugin' => 'pws', 'controller' => 'Equipamentos', 'action' => 'editTemp')); ?>/' + group_id, $('#' + id).find('form').serialize(), function (o) {
	...
	let response = null;
        ...
        if(response != null){
            ...
            const content = '<div><div><strong>O equipamento selecionado possui um chamado aberto.</strong></div>'
                          ...
                          + `<div>Aberto em: ${response.c.DTINCLUSAO}</div>`
