    ...
    <div class="row-fluid show-grid" id="tab_user_manager">
        <div class="span12">
            <ul class="nav nav-pills">
                <li class="active">
                    <a href="#" onclick="javascript:window.history.go(-1)">Voltar</a>
                </li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                <th>#</th>
                                <th>Nome</th>
                                <th>Quantidade <? echo $empresa_id; ?></th>
                                <!-- Somente para COMPUCOM -->
                                <? if($empresa_id == 42){?>
                                <th>Contador</th>
                                <? } ?>
                            </tr>
                            ...
                            <?php if ($suprimento['SuprimentoTipo']['servico'] != 1) { ?>
                                <tr>
                                    ...
                                    <? if($empresa_id == 42){?>
                                    <td>
                                        <?php echo $this->Form->input("contador", array('div' => false, 'type' => 'number', 'id' => "SolicitacaoSuprimentoContador$key", 'label' => false, 'disabled', 'error' => false)); ?>
                                    </td>
                                    <? } ?>
                                </tr>
                                <?php } ?>
...
<script>
    ...
    function countChecks(key, id) {
        if (document.getElementById(id).checked == true) {
            ...
            $("#SolicitacaoSuprimentoContador" + key).attr('name', 'data[SolicitacaoSuprimento][' + key + '][contador]').attr('required', 'true').removeAttr('disabled');
            ...
            $("#SolicitacaoSuprimentoContador" + key).attr('name', 'data[SolicitacaoSuprimento][' + key + '][contador]').attr('disabled', 'true');
        }
    }
