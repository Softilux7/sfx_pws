        ...
        <div class="row-fluid">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span4 offset5">
                            <strong> Nr Nota
                                Fiscal: </strong> <?php echo h($solicitacao['Solicitacao']['NRNFSAIDA']); ?>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="span3">
                            <strong>Código de
                                Rastreio:</strong> <?php echo h($solicitacao['Solicitacao']['cdrastreio']); ?>
                        </div>
                        <div class="span4 offset5">
                ...
                <div class="panel-footer">
                    <a class="btn " onclick="<?php echo Router::url(array('plugin' => 'pws','controller' => 'solicitacao','action' => 'index')); ?>"><?php echo __('Voltar'); ?></a>
