                    ...
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h3><i class="fa fa-check-square-o" aria-hidden="true"></i>
                               Chamados em Atendimento Opções</h3>
                        </div>
                        <div class="panel-body">
                            <form id="relatorioChamado" class="form-horizontal" accept-charset="utf-8" method="post"
                                  action="<?php echo Router::url(array('plugin' => 'pws', 'controller' => 'relatorios', 'action' => 'chamado_at_result')); ?>">
                                ...
                                <div class="control-group" id="atBox">
                                    <label for="inputat"
                                           class="control-label"><?php echo __('Atendido:'); ?><span
                                            style="color: red;">*</span> </label>

                                    <div class="controls">
                                        <?php $options = array('D' => 'Dentro do Prazo', 'F' => 'Fora do Prazo') ?>
                                        <?php echo $this->Form->select('ATENDIMENTO', $options, array('div' => false, 'label' => false, 'error' => false, 'class' => 'input-xxsmall','empty'=>false)); ?>
                                    </div>
                                </div>
                                ...
                                <div class="control-group" id="statusBox">
                                    ...
                                    <div class="controls">
                                        <?php echo $this->Form->select('DATEFILTER', array('DTATENDIMENTO' => 'Data de atendimento'), array('div' => false, 'required', 'label' => false, 'error' => false, 'class' => 'input-xxsmall')); ?>
                                        
                                    </div>
                                </div>
                                <!-- <div class="control-group" id="imagens">
                                    <label for="inputStatus"
                                           class="control-label"><span
                                            style="color: red;">*</span> </label>
                                    <div class="controls">
                                    <?php echo $this->Form->input("imagens", array('value' => 1, 'id' => "SolicitacaoSuprimentoSuprimentoTipoId$key", 'type' => 'checkbox', 'div' => false, 'label' => false, 'hiddenfield' => false, 'error' => false)); ?> <?php echo __('monstrar assinatura e fotos:'); ?>
                                    </div>
                                </div> -->
                                <p>&nbsp; </p>
                        </div>
